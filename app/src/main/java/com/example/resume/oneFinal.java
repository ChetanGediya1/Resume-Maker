...
public class oneFinal extends AppCompatActivity {
   ...
   CircleImageView users,btn_gallery;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_one_final);
        ...
        btn_gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog dialog = new Dialog(oneFinal.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else if (99 == requestCode)
        {
            Bitmap bitmap = (Bitmap) data.getExtras().get("data");
            users.setImageBitmap(bitmap);
        }
